...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Deep navy - serious, institutional, European
        navy: {
          50: '#f0f4f8',
          100: '#d9e2ec',
          200: '#bcccdc',
        ...
        // Muted gold - power, energy, urgency without being loud
        gold: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
      ...
      borderRadius: {
        // Sharper corners for professional feel
        'sm': '0.25rem',
        'DEFAULT': '0.375rem',
        'md': '0.5rem',
        'lg': '0.625rem',
